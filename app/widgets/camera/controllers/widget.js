...
function camera_callback(event){
    ...
    var img = Ti.UI.createImageView({image: blob, height:120, width: Ti.UI.SIZE});
    $.list.add(img);
    /*API.callByPost({url: "uploadDoctorDocument", params: {dr_id: args.dr_id, Filedata: blob}}, {onload: 
